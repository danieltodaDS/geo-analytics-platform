...
setup-gcloud: auth
	...
	bq mk --dataset --location=US data-pipeline-lab-497514:raw 2>/dev/null || true
	bq mk --dataset --location=US data-pipeline-lab-497514:raw_views 2>/dev/null || true
	bq mk --dataset --location=US data-pipeline-lab-497514:staging 2>/dev/null || true
	bq mk --dataset --location=US data-pipeline-lab-497514:intermediate 2>/dev/null || true
	bq mk --dataset --location=US data-pipeline-lab-497514:marts 2>/dev/null || true
